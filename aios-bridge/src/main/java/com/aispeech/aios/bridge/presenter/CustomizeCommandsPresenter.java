...
public class CustomizeCommandsPresenter {
    ...
    private static final Command BT_COMMAND_OFF = new Command(CLOSE_BT, new String[]{ "关闭蓝牙","关闭蓝牙电话", "退出蓝牙","关掉蓝牙", "关掉蓝牙电话"});//关闭蓝牙命令集
...
//        shortcutWakeupList.add(new ShortcutWakeup(TING_ZHI_DAO_HANG, 0.12f));
        ...
        shortcutWakeupList.add(new ShortcutWakeup("qi dong ying qing",0.12f));
